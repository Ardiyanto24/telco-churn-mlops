...
def predict_active(
    df: pd.DataFrame, alias: str = constants.ACTIVE_ALIAS, tracking_uri: Optional[str] = None
) -> pd.DataFrame:
    ...
    real-time API (M3.x) -- TIDAK hardcode nomor versi, mengikuti alias
    kapan pun berpindah (promosi/rollback Milestone 2.8).
