...
**Kenapa belum diputuskan sekarang:** Butuh klarifikasi Data Scientist (environment Kaggle yang dipakai, atau `pip freeze` dari sesi training asli) sebelum bisa dikunci dengan percaya diri — menebak versi berisiko training-serving skew (prinsip Bagian 2 dokumen arsitektur).

**Pemicu peninjauan:** Sebelum Milestone 1.2 mengunci dependency final. Sampai saat itu, Milestone 1.2 boleh mulai dengan versi kompatibel terkini yang ditandai eksplisit sebagai provisional.
